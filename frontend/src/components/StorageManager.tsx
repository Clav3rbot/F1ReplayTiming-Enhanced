        ...
        <div className="p-6 py-4 border-b border-white/10 overflow-y-auto min-h-0">
          ...
          {dirty && !confirm && (
            <button
              onClick={requestSave}
              disabled={busy}
              className="mt-3 px-4 py-2 bg-f1-red text-white text-sm font-bold rounded-md hover:shadow-[0_4px_15px_rgba(225,6,0,0.4)] transition-all duration-300 disabled:opacity-50"
            >
              {busy ? "Checking…" : "Save"}
            </button>
          )}
            ...
            <div className="mt-3 p-3 glass-panel rounded-lg">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={applySave}
                  disabled={busy}
                  className="px-3 py-1.5 bg-f1-red text-white text-xs font-bold rounded-md hover:shadow-[0_4px_15px_rgba(225,6,0,0.4)] transition-all duration-300 disabled:opacity-50"
                >
          ...
          {result && <p className="text-f1-green text-sm mt-2">{result}</p>}
          {error && <p className="text-f1-red text-sm mt-2">{error}</p>}
        </div>
        )}
